		...
		BigVideo.init = function() {
			if (!isInitialized) {
				...
				player.on('ended', function() {
					// $("#big-video-vid").fadeTo("slow", 0, function(){
					//		$("#big-video-vid").fadeTo("slow", 1);
					// });
					// $("#big-video-vid").fadeOut(5000, function(){
					// 	$("#big-video-vid").fadeIn(5000);
					// });
					if (settings.doLoop) {
